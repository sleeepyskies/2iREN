...
auto ResourceCommandRecorder::upload_to_buffer(
    const BufferHandle buffer_handle, const ByteBuffer& data, const u32 dest_offset
) -> void {
...
auto ResourceCommandRecorder::upload_to_image(
    const ImageHandle image_handle, std::span<const u8> data, const u32 layer
) -> void {
