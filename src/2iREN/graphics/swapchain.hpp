...
/**
 * @class Swapchain
 * @brief A collection of images tied to a specific @ref Window. Used to present images to the
 * screen.
 */
...
public:
     ...
     * @todo this api isn't great, but works for now and keeps hard dependency in 2iREN core for
     * ImGui out.
     */
