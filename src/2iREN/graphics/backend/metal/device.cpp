...
MetalDevice::MetalDevice() { UNIMPLEMENTED(); }

MetalDevice::~MetalDevice() { UNIMPLEMENTED(); }

auto MetalDevice::wait_idle() const noexcept -> void { UNIMPLEMENTED(); }
...
auto MetalDevice::destroy_image(ImageHandle handle) -> void { UNIMPLEMENTED(); }

auto MetalDevice::create_sampler(const SamplerDescriptor &descriptor)
    -> Sampler {
  UNIMPLEMENTED();
}
...
auto MetalDevice::create_swapchain(const SwapchainDescriptor &descriptor)
    -> Swapchain {
  UNIMPLEMENTED();
}
...
auto MetalDevice::create_graphics_pipeline(
    const GraphicsPipelineDescriptor &descriptor) -> GraphicsPipeline {
  UNIMPLEMENTED();
}
...
auto MetalDevice::destroy_query(QueryHandle handle) -> void { UNIMPLEMENTED(); }

auto MetalDevice::flush_delete_queue() -> void { UNIMPLEMENTED(); }
...
auto MetalDevice::graphics_pipeline_descriptor(
    GraphicsPipelineHandle handle) const -> const GraphicsPipelineDescriptor & {
  UNIMPLEMENTED();
}
...
auto MetalDevice::end_conditional_render() const -> void { UNIMPLEMENTED(); }

auto MetalDevice::acquire_next_swapchain_target(SwapchainHandle handle) const
    -> ImageHandle {
  UNIMPLEMENTED();
}

auto MetalDevice::present(SwapchainHandle handle,
                          OverlayFunction &&overlay) const -> void {
  UNIMPLEMENTED();
}

auto MetalDevice::blit_image(ImageHandle source, ImageHandle destination) const
    -> void {
  UNIMPLEMENTED();
}
...
auto MetalDevice::limits() const -> const Limits & { UNIMPLEMENTED(); }

auto MetalDevice::statistics() const -> Statistics { UNIMPLEMENTED(); }
