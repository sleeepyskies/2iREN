...
public:
    ...
    static auto invalid() -> WeakHandle {
        return WeakHandle{};
    }
    ...
    [[nodiscard]] auto id() const noexcept -> AssetId {
        return m_id;
    }
...
class StrongHandle {
    ...
    static_assert(
        siren::IsAsset<A>,
        "StrongHandle can only be used with types derived from Asset."
    );
...
public:
    ...
    static auto invalid() noexcept -> StrongHandle {
        return StrongHandle{};
    }
    ~StrongHandle() {
        if (m_weak.pool()) {
    ...
    [[nodiscard]] constexpr auto id() const noexcept -> AssetId {
        return m_weak.id();
    }
    ...
    [[nodiscard]] auto path() const -> AssetPath {
        return m_weak.path();
    }
    /// @brief Returns the string representation of this handle.
    [[nodiscard]] auto to_string() const -> std::string {
