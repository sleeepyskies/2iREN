...
void MaterialAsset::set_base_color_tex(const StrongHandle<Texture>& handle) noexcept { m_base_color_tex = handle; }
...
void MaterialAsset::set_clear_coat_roughness(const f32 value) noexcept { m_clear_coat_roughness = value; }

void MaterialAsset::set_clear_coat_tex(const StrongHandle<Texture>& handle) noexcept { m_clear_coat_tex = handle; }
...
void MaterialAsset::set_transmission_tex(const StrongHandle<Texture>& handle) noexcept { m_transmission_tex = handle; }

void MaterialAsset::set_thickness(const f32 value) noexcept { m_thickness = value; }

void MaterialAsset::set_attenuation_color(const glm::vec3& value) noexcept { m_attenuation_color = value; }

void MaterialAsset::set_attenuation_distance(const f32 value) noexcept { m_attenuation_distance = value; }
...
void MaterialAsset::set_specular_color(const glm::vec3& value) noexcept { m_specular_color = value; }

void MaterialAsset::set_specular_color_tex(const StrongHandle<Texture>& handle) noexcept {
    m_specular_color_tex = handle;
}

void MaterialAsset::set_specular_tex(const StrongHandle<Texture>& handle) noexcept { m_specular_tex = handle; }
...
void MaterialAsset::set_sheen_color_tex(const StrongHandle<Texture>& handle) noexcept { m_sheen_color_tex = handle; }
...
void MaterialAsset::set_emissive_color(const glm::vec3& value) noexcept { m_emissive_color = value; }

void MaterialAsset::set_emissive_tex(const StrongHandle<Texture>& handle) noexcept { m_emissive_tex = handle; }

void MaterialAsset::set_iridescence_factor(const f32 value) noexcept { m_iridescence_factor = value; }
...
void MaterialAsset::set_iridescence_tex(const StrongHandle<Texture>& handle) noexcept { m_iridescence_tex = handle; }
...
void MaterialAsset::set_diffuse_transmission_factor(f32 value) noexcept { m_diffuse_transmission_factor = value; }
...
void MaterialAsset::set_diffuse_transmission_color_tex(const StrongHandle<Texture>& handle) noexcept {
    m_diffuse_transmission_color_tex = handle;
}

void MaterialAsset::set_anisotropy_strength(const f32 value) noexcept { m_anisotropy_strength = value; }

void MaterialAsset::set_anisotropy_rotation(const f32 value) noexcept { m_anisotropy_rotation = value; }

void MaterialAsset::set_anisotropy_tex(const StrongHandle<Texture>& handle) noexcept { m_anisotropy_tex = handle; }

void MaterialAsset::set_dispersion(const f32 value) noexcept { m_dispersion = value; }

void MaterialAsset::set_normal_tex(const StrongHandle<Texture>& handle) noexcept { m_normal_tex = handle; }

void MaterialAsset::set_occlusion_tex(const StrongHandle<Texture>& handle) noexcept { m_occlusion_tex = handle; }
...
const StrongHandle<Texture>& MaterialAsset::base_color_tex() const noexcept { return m_base_color_tex; }

const StrongHandle<Texture>& MaterialAsset::metallic_roughness_tex() const noexcept { return m_metallic_roughness_tex; }
...
const StrongHandle<Texture>& MaterialAsset::clear_coat_tex() const noexcept { return m_clear_coat_tex; }

const StrongHandle<Texture>& MaterialAsset::clear_coat_roughness_tex() const noexcept {
    return m_clear_coat_roughness_tex;
}

const StrongHandle<Texture>& MaterialAsset::clearcoat_normal_tex() const noexcept { return m_clearcoat_normal_tex; }

f32 MaterialAsset::transmission() const noexcept { return m_transmission; }

const StrongHandle<Texture>& MaterialAsset::transmission_tex() const noexcept { return m_transmission_tex; }
...
const StrongHandle<Texture>& MaterialAsset::thickness_texture() const noexcept { return m_thickness_texture; }
...
const StrongHandle<Texture>& MaterialAsset::specular_color_tex() const noexcept { return m_specular_color_tex; }
...
const StrongHandle<Texture>& MaterialAsset::sheen_color_tex() const noexcept { return m_sheen_color_tex; }

const StrongHandle<Texture>& MaterialAsset::sheen_roughness_tex() const noexcept { return m_sheen_roughness_tex; }
...
const StrongHandle<Texture>& MaterialAsset::iridescence_tex() const noexcept { return m_iridescence_tex; }

const StrongHandle<Texture>& MaterialAsset::iridescence_thickness_tex() const noexcept {
    return m_iridescence_thickness_tex;
}

f32 MaterialAsset::diffuse_transmission_factor() const noexcept { return m_diffuse_transmission_factor; }

const glm::vec3& MaterialAsset::diffuse_transmission_color() const noexcept { return m_diffuse_transmission_color; }
...
const StrongHandle<Texture>& MaterialAsset::anisotropy_tex() const noexcept { return m_anisotropy_tex; }
...
const StrongHandle<Texture>& MaterialAsset::occlusion_tex() const noexcept { return m_occlusion_tex; }
