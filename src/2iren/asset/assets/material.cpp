...
void MaterialAsset::set_sheen_color(const glm::vec3& value) noexcept {
    m_sheen_color = value;
}

void MaterialAsset::set_sheen_roughness(const f32 value) noexcept {
...
void MaterialAsset::set_emissive_strength(const f32 value) noexcept {
...
void MaterialAsset::set_dispersion(const f32 value) noexcept {
    m_dispersion = value;
}
...
void MaterialAsset::set_alpha_mode(const AlphaMode value) noexcept {
    m_alpha_mode = value;
}

void MaterialAsset::set_alpha_cutoff(const f32 value) noexcept {
    m_alpha_cutoff = value;
}

void MaterialAsset::set_double_sided(const bool value) noexcept {
    m_double_sided = value;
}

void MaterialAsset::set_unlit(const bool value) noexcept {
    m_unlit = value;
}
...
const glm::vec3& MaterialAsset::attenuation_color() const noexcept {
    return m_attenuation_color;
}

f32 MaterialAsset::attenuation_distance() const noexcept {
...
const glm::vec3& MaterialAsset::specular_color() const noexcept {
...
const StrongHandle<Texture>& MaterialAsset::specular_tex() const noexcept {
    return m_specular_tex;
}

const glm::vec3& MaterialAsset::sheen_color() const noexcept {
    return m_sheen_color;
}

f32 MaterialAsset::sheen_roughness() const noexcept {
...
f32 MaterialAsset::emissive_strength() const noexcept {
    return m_emissive_strength;
}

const glm::vec3& MaterialAsset::emissive_color() const noexcept {
    return m_emissive_color;
}

const StrongHandle<Texture>& MaterialAsset::emissive_tex() const noexcept {
...
f32 MaterialAsset::anisotropy_strength() const noexcept {
    return m_anisotropy_strength;
}

f32 MaterialAsset::anisotropy_rotation() const noexcept {
...
f32 MaterialAsset::dispersion() const noexcept {
    return m_dispersion;
}

const StrongHandle<Texture>& MaterialAsset::normal_tex() const noexcept {
    return m_normal_tex;
}
...
AlphaMode MaterialAsset::alpha_mode() const noexcept {
    return m_alpha_mode;
}

f32 MaterialAsset::alpha_cutoff() const noexcept {
    return m_alpha_cutoff;
}

bool MaterialAsset::double_sided() const noexcept {
    return m_double_sided;
}

bool MaterialAsset::unlit() const noexcept {
    return m_unlit;
}
